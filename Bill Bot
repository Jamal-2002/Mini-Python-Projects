#In this program, I built a rule-based chatbot that is capable of serving a couple of hypothetical user needs. The chatbot that I developed is small and does not offer a lot of functionality.
...
# Creating a SupportBot instance
